...
def admin_panel():
    ...
    <div style="background: linear-gradient(135deg, #2c5aa0 0%, #5fa2e8 100%); color: white; padding: 1.5rem 2rem; border-radius: 12px; margin-bottom: 1.5rem; box-shadow: 0 4px 12px rgba(44, 90, 160, 0.2);">
        <div style="font-size: 1.6rem; font-weight: 700;">🛠️ Admin Panel</div>
        <div style="font-size: 0.85rem; opacity: 0.9;">User Management & Audit Trails</div>
    </div>
    ...
    with t1:
        ...
        with st.form("add_user_form"):
            ...
            with col2:
                new_role = st.selectbox("Role", ["executive", "pm", "recorder", "admin"])
